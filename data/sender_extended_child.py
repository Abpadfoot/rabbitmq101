...
alternate_exchange_ob.declare_queue('queue_timestamp')
...
alternate_exchange_ob.bind_queue_to_exchange(queue_name='queue_timestamp', exchange_name=source_name, key='time')
...
alternate_exchange_ob.publish_message(exchange_name=source_name,
                                      message_body='This is an timestamp message at 17:39', key='time')
